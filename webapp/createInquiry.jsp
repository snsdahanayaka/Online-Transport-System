	...
	<body>
		...
		<body>
		    ...
		    <form action="inq" method="post">
		    		...
		    		Inquiry  Subject:<br><input type = "text" name ="subject"   ><br>
		    		<label for="message">Inquiry Message:</label><br>
		    		
					<textarea id="message" name="message" rows="4" cols="50" placeholder="Enter Inquiry...">
					</textarea><br>
		    	    <br>
		   ...
		   <a href="inqde"  ><button class="button button1">My Inquires</button></a>
